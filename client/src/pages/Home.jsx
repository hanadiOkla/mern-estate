...
function Home() {
  ...
  useEffect(() => {
    ...
    const fetchRentListings = async () => {
      try {
        ...
        fetchSaleListings(); // تعديل إملائي بسيط لضمان الاستدعاء الصحيح
      } catch (error) {
        console.log(error);
      }
    };
  ...
  return (
    <div>
      {/* top */}
      <div className="flex flex-col gap-6 p-28 px-3 max-w-[75%] mx-auto">
      ...
      <div className="max-w-[75%] mx-auto p-3 flex flex-col gap-8 my-10">
        {
          offerListings && offerListings.length > 0 && (
            <div className="">
              <div className="my-3">
